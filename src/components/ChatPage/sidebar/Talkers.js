...
import ContextMenuWrapper from '../../ContextMenus/ContextMenu';
...
const Talkers = ({ t }) => {
  ...
  return (
    <ContextMenuWrapper talker={t} muted={muted} setMuted={setMuted}>
      <div className ="voice-member-container">
        ...
        { muted && <div className="mic-muted">{mutedMic}</div> }
      </div>
    </ContextMenuWrapper>
  )
}
